...
Если вы хотите обслуживать файлы непосредственно из встроенного приложения, укажите "root ./", так как без указания опции root по умолчанию будет использоваться embedded_app/public.
