...
> [!TIP]
> À partir de Symfony 7.4, le package `runtime/frankenphp-symfony` n'est plus nécessaire, car Symfony Runtime prend en charge nativement le mode worker de FrankenPHP.
