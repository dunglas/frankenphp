...
'frankenphp' is responsible for starting up the global PHP instance and all threads
...
func parseFrankenPhpDirective(d *caddyfile.Dispenser, _ interface{}) (interface{}, error) {
	app := &FrankenPHPApp{}
